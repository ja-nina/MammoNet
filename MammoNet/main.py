...
if __name__ == "__main__":
    ...
    simple_cnn_no_aug.train(train_loader_no_aug, val_loader_no_aug, test_loader_no_aug, augment=False)
    ...
    simple_cnn_with_aug.train(train_loader_with_aug, val_loader_with_aug, test_loader_with_aug, augment=True)
    ...
    simpler_nn_no_aug.train(train_loader_no_aug, val_loader_no_aug, test_loader_no_aug, augment=False)
    ...
    simpler_nn_with_aug.train(train_loader_with_aug, val_loader_with_aug, test_loader_with_aug, augment=True)
    ...
    vit_model_no_aug.train(train_loader_no_aug, val_loader_no_aug, test_loader_no_aug, augment=False)
    ...
    vit_model_with_aug.train(train_loader_with_aug, val_loader_with_aug, test_loader_with_aug, augment=True)
